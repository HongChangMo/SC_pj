	...
	<div class="pagetitle">
		...
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="/community/communityList">커뮤니티</a></li>
				<li class="breadcrumb-item active">New 커뮤니티</li>
			</ol>
		</nav>
	</div>
		...
		<div class="card">
			<div class="card-header">
				<div class="pagetitle" style="padding-top:80px;">
					<h1 align="center" style="font-size:30px">커뮤니티</h1>
				</div>
			</div>
